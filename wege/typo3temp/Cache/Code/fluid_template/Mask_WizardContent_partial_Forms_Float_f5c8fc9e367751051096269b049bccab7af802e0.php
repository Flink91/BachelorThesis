<?php
class FluidCache_Mask_WizardContent_partial_Forms_Float_f5c8fc9e367751051096269b049bccab7af802e0 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '][--index--]" value="double(11,2) DEFAULT \'0.00\' NOT NULL" />
<input type="hidden" name="tx_mask_tools_maskmask[dummy][--index--][int]" value="double2" class="tx_mask_fieldcontent_eval" />
<input type="hidden" name="tx_mask_tools_maskmask[storage][tca][--index--][config][eval]" value="double2" class="tx_mask_fieldcontent_evalresult" />

<div class="row">
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="float_size">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments4 = array();
$arguments4['key'] = 'tx_mask.field.float.size';
$arguments4['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="float_size" name="tx_mask_tools_maskmask[storage][tca][--index--][config][size]" type="number" class="form-control" min="1" max="48" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments6 = array();
...
$output0 .= '" />
	...
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="float_max">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments9 = array();
$arguments9['key'] = 'tx_mask.field.float.max';
$arguments9['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="float_max" name="tx_mask_tools_maskmask[storage][tca][--index--][config][max]" type="number" class="form-control" min="0" max="512" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments11 = array();
...
<div class="row">
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="float_lower">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments14 = array();
$arguments14['key'] = 'tx_mask.field.float.range.lower';
$arguments14['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="float_lower" type="number" class="form-control" name="tx_mask_tools_maskmask[storage][tca][--index--][config][range][lower]" max="1000000000" min="0" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments16 = array();
...
$output0 .= '">
	...
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="float_upper">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments19 = array();
$arguments19['key'] = 'tx_mask.field.float.range.upper';
$arguments19['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="float_upper" type="number" class="form-control" name="tx_mask_tools_maskmask[storage][tca][--index--][config][range][upper]" max="1000000000" min="0" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments21 = array();
...
<div class="row">
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="float_default">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments24 = array();
$arguments24['key'] = 'tx_mask.field.float.default';
$arguments24['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="float_default" name="tx_mask_tools_maskmask[storage][tca][--index--][config][default]" type="text" class="form-control" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments26 = array();
