<?php
class FluidCache_Mask_WizardContent_partial_Forms_Text_4fac8411d7186b2d2a3fd9f2a618349e08170e87 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="row">
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="text_cols">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments4 = array();
$arguments4['key'] = 'tx_mask.field.text.cols';
$arguments4['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="text_cols" name="tx_mask_tools_maskmask[storage][tca][--index--][config][cols]" type="number" class="form-control" title="cols" placeholder="cols" min="1" max="48" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments6 = array();
...
$output0 .= '" />
	...
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="text_rows">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments9 = array();
$arguments9['key'] = 'tx_mask.field.text.rows';
$arguments9['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="text_rows" name="tx_mask_tools_maskmask[storage][tca][--index--][config][rows]" type="number" class="form-control" title="rows" placeholder="rows" min="0" max="20" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments11 = array();
...
<div class="row">
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="text_default">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments14 = array();
$arguments14['key'] = 'tx_mask.field.text.default';
$arguments14['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="text_default" name="tx_mask_tools_maskmask[storage][tca][--index--][config][default]" type="text" class="form-control" title="default" placeholder="default" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments16 = array();
