<?php
class FluidCache_Mask_WizardContent_partial_TCA_Trim_53ded5cffa5464fe870f6c75f7e35f4502229e74 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '
<label class="t3js-formengine-label" for="all_trim">
	';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments1 = array();
$arguments1['key'] = 'tx_mask.field.trim';
$arguments1['id'] = NULL;
...
<div class="t3js-formengine-field-item">
	<div class="form-control-wrap" style="">
		<input id="all_trim" class="tx_mask_fieldcontent_eval" name="tx_mask_tools_maskmask[dummy][--index--][trim]" type="checkbox" ';
...
$output0 .= ' value="trim" title="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments17 = array();
$arguments17['key'] = 'tx_mask.content.trim';
$arguments17['id'] = NULL;
