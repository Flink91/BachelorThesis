<?php
class FluidCache_ExternalImport_DataModule_action_editTask_4f31e61068e50837fd9391965548818a01ff12f3 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments3['condition'] = TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\BooleanNode::evaluateComparator('==', \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('task'), 'table', $renderingContext), 'all');
...
$arguments16 = array();
$arguments16['table'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('task'), 'table', $renderingContext);
...
$array15['1'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('task'), 'table', $renderingContext);
$array15['2'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('task'), 'index', $renderingContext);
...
// Rendering ViewHelper Cobweb\ExternalImport\ViewHelpers\Be\TableTitleViewHelper
$arguments25 = array();
$arguments25['table'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('task'), 'table', $renderingContext);
...
$array24['1'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('task'), 'table', $renderingContext);
$array24['2'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('task'), 'index', $renderingContext);
