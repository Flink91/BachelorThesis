<?php
class FluidCache_Powermail_Form_partial_Form_Submit_07a7253646fd658d04b8bf694cf4050e65fa03e0 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '" class="powermail_fieldwrap powermail_fieldwrap_submit powermail_fieldwrap_';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments4 = array();
...
$arguments10 = array();
$arguments10['value'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('field'), 'title', $renderingContext);
$arguments10['class'] = 'powermail_field powermail_submit';
