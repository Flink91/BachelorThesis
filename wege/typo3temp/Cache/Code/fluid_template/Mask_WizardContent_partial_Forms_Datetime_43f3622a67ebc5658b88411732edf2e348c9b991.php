<?php
class FluidCache_Mask_WizardContent_partial_Forms_Datetime_43f3622a67ebc5658b88411732edf2e348c9b991 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<input type="hidden" name="tx_mask_tools_maskmask[storage][tca][--index--][config][dbType]" value="datetime" />
...
$output0 .= '][--index--]" value="datetime DEFAULT \'0000-00-00 00:00:00\'" />
...
<div class="row">
	<div class="form-group col-sm-6">
		<label class="t3js-formengine-label" for="datetime_default">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
$arguments4 = array();
$arguments4['key'] = 'tx_mask.field.datetime.default';
$arguments4['id'] = NULL;
...
$output0 .= '
		...
		<div class="t3js-formengine-field-item">
			<div class="form-control-wrap" style="">
				<input id="datetime_default" name="tx_mask_tools_maskmask[storage][tca][--index--][config][default]" type="text" class="form-control" value="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments6 = array();
