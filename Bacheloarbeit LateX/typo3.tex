...
Die meisten hier präsentierten Information entspringen den offiziellen Typo3 Docs\footnote{https://docs.typo3.org/} und einem Lernkurs des Rheinwerk Verlages zur neuen Typo3 Version \cite{typo3cms7}. Spezifische Verweise werden natürlich extra angegeben.

\section{Version und Hintergrund}
Typo3 ist ein Open Source CMS, ursprünglich entwickelt von Kasper Skårhøj und basiert auf der Programmiersprache PHP. Bei der Popularität von Open Source Web Content Management Systemen belegt es, je nach Quelle, meist den fünften Platz\footnote{http://trends.builtwith.com/cms/open-source Mai 2016: Platz 5}. Typo3 umfasst eine Fülle an Versionen und spaltete sich 2015 sogar in zwei verschiedene Kernentwicklungsteams. Eines das weiter an Typo3 CMS arbeitet und eines, das an Typo3 Neos arbeitet. Diese Arbeit basiert auf der neuesten Version von Typo3 CMS 7.6 LTS. 
...
Zu Beginn wird eine Variable mit dem Namen page gesetzt, welche die ganze Seite präsentiert.
